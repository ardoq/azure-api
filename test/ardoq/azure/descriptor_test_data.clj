...
(def swagger-unresolved
  {:parameters {:ApiVersionParameter {:description "The API version to use for this operation."
                                      ...
                                      :required true
                                      :type "string"}}
   :paths {"/providers/Microsoft.Authorization/elevateAccess"
           {:post {:description "Elevates access for a Global Administrator."
...
(def swagger-resolved
  {:parameters {:ApiVersionParameter {:description "The API version to use for this operation."
   ...
   :paths {"/providers/Microsoft.Authorization/elevateAccess"
           {:post {:description "Elevates access for a Global Administrator."
                   :operationId "ElevateAccess_Post"
                   :parameters [{:description "The API version to use for this operation."
                                 :in "query"
                                 :name "api-version"
                                 :required true
                                 :type "string"}]
...
(def paths-unconverted
  {"some/path/like/this" {:get
                          {:description "A description"
                           ...
                           :parameters [{:description "Whatever"
                                         :in "query"
                                         :name "api-version"
                                         :required true
                                         :type "string"}]}
                          ...
                          {:description "Another description"
                           ...
                           :parameters [{:description "Who cares"
                                         :in "body"
                                         :name "post-message"
                                         :required true
                                         :type "string"}]}}
